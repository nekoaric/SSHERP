...
Ext.extend(Ext.ux.grid.GridSummary, Ext.util.Observable, {
  init : function(grid) {
    ...
    if(v instanceof Ext.ux.grid.LockingGridView){
        this.grid.addListener('bodyscroll',function(){
            // 设置div的宽度和grid相同 为了能够设置下面的滚动效果
            var mb = this.view.scroller.dom;
            var curDom = this.view.summaryWrap.dom;
            curDom.style.width = mb.style.width;
        ...
        }/*function(){console.log('scroll')}*/)
        this.grid.addListener('columnmove',callbackFun(this))
        
        function callbackFun(that){
            return function(){
                that.setSumValue(that.jsonV);
            }
