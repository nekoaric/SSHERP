...
Ext.onReady(function() {
			...
			var grid = new Ext.grid.GridPanel({
						title : '<img src="./resource/image/ext/plugin.png" align="top" class="IEPNG"><span style="font-weight:normal">SpringBean监控</span>',
						...
						tbar : [{
									...
									format : 'Y-m-d',
									width : 100
								}, '-', pointcuttypeCombo, '-', advisetypeCombo, '-', new Ext.form.TextField({
											id : 'keyword',
											name : 'keyword',
											emptyText : '关键字过滤',
