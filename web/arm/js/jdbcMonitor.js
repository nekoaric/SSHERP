...
Ext.onReady(function() {
			var expander = new Ext.grid.RowExpander({
						tpl : new Ext.Template('<p style=margin-left:70px;><span style=color:Teal;>执行SQL</span><br><span>{sql}</span></p>',
			...
			var grid = new Ext.grid.GridPanel({
						title : '<img src="./resource/image/ext/database_refresh.png" align="top" class="IEPNG"><span style="font-weight:normal">JDBC执行监控</span>',
