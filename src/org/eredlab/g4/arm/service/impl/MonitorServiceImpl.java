...
public class MonitorServiceImpl extends BaseServiceImpl implements MonitorService {
	...
	public void saveEvent(Dto dto) {
		...
		Dto to = new BaseDto();
		String evencode=dto.getAsString("requestpath")+"/"+dto.getAsString("methodname");
		to.put("evencode", evencode);
		String description=(String) g4Dao.queryForObject("queryEVENTCODE",to);
