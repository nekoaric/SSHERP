...
public class UiGrantTag extends TagSupport{
	...
	public int doStartTag() throws JspException{
        ...
        //'0', '挂起';'1', '禁用';'2', '激活'; '3', '只读'; '4', '编辑';'5', '显示';'6', '隐藏';
		List roleGrantList = g4Dao.queryForList("getUiRoleGrantInfo", qDto);
//		List userGrantList = g4Dao.queryForList("getUiUserGrantInfo", qDto);
...
//		}
		...
		try {
			...
			log.error("生成模版文件失败!" + e.getMessage());
			e.printStackTrace();
		}
