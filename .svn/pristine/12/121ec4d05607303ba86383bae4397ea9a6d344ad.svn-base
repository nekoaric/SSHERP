...
import com.cnnct.sys.web.tag.vo.RoleVo;
...
public class ArmSelectRoleTreeTag extends TagSupport {
	...
	public int doStartTag() throws JspException{
		...
		List deptList = g4Dao.queryForList("queryDeptsForUserGrant", deptDto);
		...
		List grantList = g4Dao.queryForList("queryGrantedRolesByUserId", grantDto);
