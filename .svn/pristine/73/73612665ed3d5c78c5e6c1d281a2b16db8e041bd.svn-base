 ...
 * @since 2014-9-26
 */
public class SaveRequestQuartz extends BaseServiceImpl implements TaskQuartzService{
	/**
	 ...
	 * @param dto
	 */
	public static void addRequestInfo(Dto dto){
		resultList.add(dto);
	}
	...
	public void quartzExecute() throws Exception {
		...
		try{
			if(resultList.size()>0){	// 数据不为空则处理
				...
				g4Dao.batchInsertBaseDto("insertSysRequestList", resultBackup);
